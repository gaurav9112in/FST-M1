...
public class GoogleKeep_Activity3 {
	...
	WebDriverWait wait;
		...
		public void addNoteWithReminder() throws InterruptedException {
		 ...
		 driver.findElementById("editable_title").sendKeys("Flight to USA"); 
		 
		 // Add the Note 
		 wait.until(ExpectedConditions.elementToBeClickable(driver.findElementById("edit_note_text")));
		 driver.findElementById("edit_note_text").sendKeys("There is a Flight scheduled at 2 PM");
		 ...
		 Assert.assertEquals(notes, "There is a Flight scheduled at 2 PM");
